...
class OuterClass {
  ...
  private static <T extends java.util.List<String>> void complexGenericMethod(T argument) { // Noncompliant {{Remove this unused private "complexGenericMethod" method.}}
  }
  ...
  class ComplexNestedGenericClass<T extends java.util.Collection<Object>> {
    private ComplexNestedGenericClass(T argument) { // Noncompliant {{Remove this unused private "ComplexNestedGenericClass" constructor.}}
      // FALSE POSITIVE: see http://jira.sonarsource.com/browse/SONARJAVA-1150
    }

    private void genericMethod(T argument) { // Noncompliant {{Remove this unused private "genericMethod" method.}}
      // FALSE POSITIVE: see http://jira.sonarsource.com/browse/SONARJAVA-1150
    }
  }
